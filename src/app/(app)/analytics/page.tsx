...
// import type { OrderItem } from "@/context/useAppStore";
// import {
//   Select,
//   SelectContent,
//   SelectItem,
...
//   count: { label: "Reviews", color: "hsl(var(--chart-4))" },
// };
...
//       .map((cat, i) => ({
//         ...cat,
//         color: ["bg-primary", "bg-sky-500", "bg-green-500"][i],
//       }));

//     const totalTimeSales = Object.values(timeSales).reduce(
//       (sum, time) => sum + time.sales,
//       0
//     );
...
//         percentage:
//           totalTimeSales > 0
//             ? Math.round((data.sales / totalTimeSales) * 100)
//             : 0,
//       }))
//       .map((time, i) => ({
//         ...time,
//         color: ["bg-yellow-400", "bg-purple-500", "bg-red-500"][i],
//       }));

//     const totalContribution = Object.values(revenueContributions).reduce(
//       (sum, r) => sum + r.sales,
//       0
//     );
...
//         percentage:
//           totalContribution > 0
//             ? Math.round((data.sales / totalContribution) * 100)
//             : 0,
//       }))
//       .sort((a, b) => b.sales - a.sales)
//       .map((c, i) => ({
...
//     const totalPromotionImpact = Object.values(promotionImpacts).reduce(
//       (sum, r) => sum + r.sales,
//       0
//     );
...
//         sales: data.sales,
//         percentage:
//           totalPromotionImpact > 0
//             ? Math.round((data.sales / totalPromotionImpact) * 100)
//             : 0,
//       }))
//       .sort((a, b) => b.sales - a.sales)
//       .map((c, i) => ({
//         ...c,
//         color: ["bg-teal-500", "bg-amber-500", "bg-indigo-500", "bg-pink-500"][
//           i
//         ],
//       }));
...
//       salesByTimeData: salesByTime,
//       revenueContributionData: revenueContribution,
//       promotionImpactData: promotionImpact,
//     };
//   }, [orders]);
...
//     () => Math.max(...menuRevenueData.map((d) => d.revenue)),
//     [menuRevenueData]
//   );
...
//                   <Tabs
//                     value={salesTimeRange}
//                     onValueChange={(value) => setSalesTimeRange(value)}
//                     className="w-auto"
//                   >
...
//                         <div
//                           className={cn("h-8 w-1.5 rounded-sm", item.color)}
//                         ></div>
//                         <div>
...
//                           <p className="font-medium">{item.name}</p>
//                           <p className="text-sm text-muted-foreground">
//                             {item.percentage}% of promo sales
//                           </p>
//                         </div>
//                       </div>
//                       <p className="font-semibold flex items-center">
...
//                 <CardDescription>
//                   A look at your daily order volume.
//                 </CardDescription>
//               </CardHeader>
//               <CardContent>
//                 <ChartContainer
...
//                             <foreignObject x="0" y="-10" width="40" height="20">
...
//                   <div
//                     key={theme}
//                     className="flex items-center gap-2 bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 text-sm px-3 py-1 rounded-full"
//                   >
...
//                               (item.sales /
//                                 Math.max(
//                                   ...popularItemsData.map((i) => i.sales)
//                                 )) *
//                               100
//                             }%`,
//                           }}
...
//                     </div>
//                     <Progress
//                       value={(item.revenue / maxMenuRevenue) * 100}
//                       className="h-2"
//                     />
//                   </div>
//                 ))}
  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center">
      <h1 className="text-4xl md:text-6xl font-bold tracking-tighter">
        <span className="text-slate-900">Coming </span>
        <span className="text-green-600 dark:text-green-400">Soon</span>
      </h1>
    </div>
  );
}